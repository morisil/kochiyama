...
public class OrientaleUnrollMorePossibilitiesIntent implements UnrollMorePossibilitiesIntent {

  @Inject WebDriver driver;

  @Override
  public Void act() {
        driver.findElement(By.xpath("//div[@class='pagination']/a[contains(.,'next')]")).click();
    return null;
  }
}
