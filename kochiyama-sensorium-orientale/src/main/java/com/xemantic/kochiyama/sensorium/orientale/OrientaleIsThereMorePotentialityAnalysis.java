...
import com.xemantic.kochiyama.lust.basic.SimpleDecidingNowIntent;
import javax.inject.Inject;
import org.openqa.selenium.By;
import org.openqa.selenium.WebDriver;

public class OrientaleIsThereMorePotentialityAnalysis implements IsThereMorePotentialityAnalysis {
  ...
  public DecidingNowIntent analyze() {
    return new SimpleDecidingNowIntent(
        !driver
            .findElements(By.xpath("//div[@class='pagination']/a[contains(.,'next')]"))
            .isEmpty());
  }
}
